//
// Porter-style stemmer. Ported verbatim from the original
// src/state/stemmer.ts; pure and engine-independent. Used by the BM25
// tokenizer and synonym map so the search ranking is bit-for-bit
// compatible with the predecessor.
