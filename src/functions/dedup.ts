//
// Short-TTL dedup map for the observe write path. Ported verbatim from
// the original src/functions/dedup.ts. Hashes (sessionId + toolName +
// truncated tool_input) and suppresses re-observation of the identical
// tool call within a 5-minute window. The cleanup timer is unref'd so it
